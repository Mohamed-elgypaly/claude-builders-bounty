...
### 📊 Risk Profile
(Provide a brief explanation of the {risk_score}/10 score and why it's {risk_label}.)
...
---
*Review generated by PR Reviewer Agent v3.1 ({engine.capitalize()}) — High Signal Defense Enabled*
"""
